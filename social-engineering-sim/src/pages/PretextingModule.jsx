          ...
          <div className="p-10 space-y-10">
            ...
            <section className="grid md:grid-cols-3 gap-6">
              <div className="bg-slate-900/80 border border-cyan-800 rounded-lg p-4">
                ...
                <p className="text-xs text-slate-300">
                  Learn how attackers use believable stories to get information
                  or access without needing to hack anything.
                </p>
              </div>
              <div className="bg-slate-900/80 border border-cyan-800 rounded-lg p-4">
                <h2 className="text-sm font-semibold text-cyan-300 mb-2">
            ...
            <section className="space-y-3">
              ...
              <p className="text-sm text-slate-300">
                ...
                usually involves direct interaction. This could be through phone
                calls, messages, or face to face conversations.
                <br />
                <br />
                ...
                <br />
                <br />
                Pretexting works because it targets human behaviour rather than
                technology. It relies on trust, authority, and the natural
